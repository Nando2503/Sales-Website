...
namespace SalesWebMvc3.Data
{
    public class SeedingService
    {
        ...
        public SalesWebMvc3Context _context;
        ...
        public void Seed()
        {
            if (_context.Departments.Any() || _context.Sellers.Any() || _context.SalesRecord.Any())
            {
            ...
            Seller s3 = new Seller(3, "Alex Grey", "alex@hotmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "marthared2423@yahoo.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "realdonaldblue@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Seller s6 = new Seller(6, "Alex Pink", "pinkalex@outlook.com", new DateTime(1997, 3, 4), 3000.0, d2);
